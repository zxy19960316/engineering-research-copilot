...
- [ ] Independent non-nuclear F04 upstream lineage reaches new M1_COMPLETE, valid provisional M2.1.1, explicit user confirmation, independent acceptance, and eligible case status before any new fresh-context run.
